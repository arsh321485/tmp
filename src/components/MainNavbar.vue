      ...
      <div class="nav-shell">
        ...
        <div class="nav-center">
          <ul class="main-menu" :class="{ 'is-open': isMobileMenuOpen }">
            <li><a href="#top" class="menu-link active-pill" @click="closeMobileMenu">HOME</a></li>
            ...
            <li class="menu-item modules" @mouseenter="openModules" @mouseleave="closeModules">
              ...
              <ul class="submenu" :class="{ open: modulesOpen }" @click.stop>
                <li><a href="#cybersecurity" class="submenu-link" @click="closeMobileMenu">Cybersecurity</a></li>
                <li><a href="#business-continuity" class="submenu-link" @click="closeMobileMenu">Business Continuity</a></li>
                <li><a href="#data-privacy" class="submenu-link" @click="closeMobileMenu">Data Privacy</a></li>
                <li><a href="#esg" class="submenu-link" @click="closeMobileMenu">ESG</a></li>
              </ul>
            </li>

            <li><a href="#features" class="menu-link" @click="closeMobileMenu">Industries</a></li>
            <li><a href="#!" class="menu-link" @click="closeMobileMenu">Badge Verification</a></li>
            <li><a href="#blog" class="menu-link" @click="closeMobileMenu">About Us</a></li>
            <li><a href="#contact" class="menu-link" @click="closeMobileMenu">Pricing</a></li>
            <li><a href="#contact" class="menu-link" @click="closeMobileMenu">FAQ</a></li>
          </ul>
        </div>
...
.nav-area {
  ...
  left: 0;
  right: 0;
  top: 14px;              /* small offset from top */
  z-index: 2000;
  pointer-events: none;   /* allow clicks only on inner shell */
}
...
.nav-shell {
  width: 100%;
  max-width: 1242px;    /* control width of pill */
...
/* left icons */
.nav-left-icons { display:flex; align-items:center; gap:16px; }
.logo-mark {
...
.menu-link {
  display:inline-flex; align-items:center; gap:6px; color:#0f1724; padding:8px 12px; border-radius:20px;
  text-decoration:none;
}
.menu-link.active-pill {
  background:#0f1724; color:#fff; padding:9px 24px; border-radius:999px;
}

/* submenu caret */
.caret { font-size:10px; transition: transform .18s; }
...
/* auth small buttons */
.auth-buttons { align-items:center; gap:6px; }
.link-btn {
  background:transparent; border:none; font-weight:600; color:#111827; cursor:pointer;
  padding:4px 8px;
}
...
.nav-center .main-menu > li { position: relative; }

/* mobile behavior */
@media (max-width: 991.98px) {
  .nav-area { top: 8px; } /* slightly smaller top offset on mobile */
  .nav-shell { padding: 10px 16px; border-radius: 28px; max-width: none; width: 100%; }
  .nav-toggle { display: inline-flex !important; }
  .main-menu { display:none; flex-direction:column; align-items:flex-start; gap:12px; padding-top:12px; border-top:1px solid #eef2f7; margin-top:12px; width:100%; }
  .main-menu.is-open { display:flex; }
  .main-menu li { width:100%; }
  .menu-link { padding:8px 6px; display:block; width:100%; }
}
</style>