    ...
    <div class="container">
      <div class="auth-wrapper">
        ...
        <div class="auth-left">
          ...
          <p class="step-text">Magic link sent!</p>


          <p class="step-para">We’ve sent you a magic link to confirm your email address.Please click on the link and
            start your Testmyplan journey.</p>

          

          <router-link to="/organisation" class="btn-primary d-inline-flex align-items-center justify-content-center">
            Next: Go to Organization
